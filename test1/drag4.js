...
(function (global) {
    ...
    drag.fn.extend({
       getDomPosition(){
            ...
            if(self.orgStyle){
                this.orgStyleData = {};
                this.orgStyleData.left = Number((String(this.orgStyle.left)).replace('px',''))||0;
                this.orgStyleData.top = Number((String(this.orgStyle.top)).replace('px',''))||0;
            }
            if(self.moveSelect){
        ...
        startClick: function(){
            ...
            this.dom.addEventListener('mousedown',function(e){
                ...
                if(self.helper){
                    ...
                    dom.style.left = self.orgDom.offsetLeft+"px";
                    dom.style.top = self.orgDom.offsetTop+"px";
